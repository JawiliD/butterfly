...
if(isset($_POST['submit'])){    
    ...
    $queryOfficials = "INSERT INTO `official_details` (ltr_permit_id, oicOfficer, inspectingOfficer, designation) VALUES ('$id','$oic', '$inspecting','$designation')";
    $sqlOfficials = mysqli_query($con,$queryOfficials);
    
    if ($sqlPayment && $sqlOfficials) {
        header('location: generate-docs.php');
    } else {
...
<div id="paymentModal" class="payment-modal">
        <div class="payment-modal-content">
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <input type="hidden" name="generate-id" value="<?php echo $id; ?>">
                    <td> <?php echo'<input type="hidden" name="generate-id" value="'.  $row['id'] .'"> ' ?></td>
