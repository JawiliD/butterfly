...
if(isset($_POST['save'])){ 
    ...
    $sql="INSERT into `user_tb` (username,email,password,role,firstName,surname) values('$username','$email','$password','$role','$firstName','$surname')";
            ...
            <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <input name="surname" type="text" placeholder="Surname" required="required">
