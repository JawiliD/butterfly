...
if (isset($_POST['submit'])) {
    ...
    $queryLTRpermit = "INSERT INTO `ltr_permit` (userId,name, address, contact, wcpNo, wfpNo, destination, mode, purpose, date, status) VALUES ('$id','$name', '$address', '$contact', '$wcp', '$wfp', '$destination', '$mode', '$purpose', '$dateTime', '$status')";
...
<div class="right-header">
        ...
        <ul>
            <li class="admin" ><h4></i><a href="client-home.php">Home</a></h4></li>
        ...
        <form id="permitForm" method="POST">
                ...
                <table class="butterfly-details-table">
                    <thead>
                        ...
                        <tr>
                            <td> 
                            <select name="butterfly-name" style="width:100%;">
                                <option value="">Select a butterfly</option>
                                <?php 
                                $queryButterfly = "SELECT * FROM butterfly";
                                $sqlButterfly = mysqli_query($con, $queryButterfly);

                                while ($row = mysqli_fetch_array($sqlButterfly)) {
